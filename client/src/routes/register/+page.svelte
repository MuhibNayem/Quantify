...
<div
	class="flex min-h-screen bg-gradient-to-br from-slate-50 to-emerald-50 dark:from-slate-900 dark:to-slate-800"
>
	...
	<div class="relative hidden flex-1 lg:flex">
		...
		<div class="relative z-10 flex flex-col justify-between p-12 text-white">
			...
			<div class="max-w-md">
				<h2 class="mb-4 text-3xl font-bold">Join Our Platform</h2>
				<p class="leading-relaxed text-emerald-100/90">
					Create your account to start managing inventory efficiently. Choose the right role for
					your responsibilities and get started in minutes.
				</p>
			</div>
			<div class="space-y-3">
	...
	<div class="flex flex-1 items-center justify-center p-8">
		<div class="w-full max-w-md space-y-8">
			...
			<Card
				class="rounded-2xl border-0 bg-white/80 shadow-xl backdrop-blur-sm dark:bg-slate-800/80"
			>
				<CardHeader class="pb-2 pt-8 text-center">
				...
				<CardContent class="p-8 pt-4">
					...
					>
						<div class="space-y-4">
							<div class="space-y-2">
								...
								<Input
									...
									bind:value={username}
									required
									class="h-12 rounded-lg border-slate-300 bg-white transition-colors focus:border-emerald-500 focus:ring-emerald-500 dark:border-slate-600 dark:bg-slate-700"
								/>
							</div>
							...
							<div class="space-y-2">
								...
								{#if confirmPassword && password !== confirmPassword}
									<p class="flex items-center space-x-1 text-xs text-red-500">
										<svg
											xmlns="http://www.w3.org/2000/svg"
											class="h-3 w-3"
											viewBox="0 0 20 20"
							...
							<div class="space-y-2">
								...
								<select
									class="h-12 w-full appearance-none rounded-lg border-slate-300 bg-white px-4 text-sm transition-colors focus:border-emerald-500 focus:ring-emerald-500 dark:border-slate-600 dark:bg-slate-700"
						...
						<Button
							type="submit"
							class="h-12 w-full rounded-lg bg-gradient-to-r from-emerald-600 to-emerald-700 font-semibold text-white shadow-lg transition-all duration-200 hover:from-emerald-700 hover:to-emerald-800 hover:shadow-xl disabled:opacity-50"
					...
					<div class="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
						...
						<a
							href="/login"
							class="font-semibold text-emerald-600 transition-colors hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300"
						>
							Sign in here
						</a>
					</div>
